        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Dòng sản phẩm</a></li>
                </ol>
            </div>
            <!-- row -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Tạo Mới Dòng Sản Phẩm</h4>
                        </div>
                        <div class="card-body">
                            <div class="form-validation">
                                <form action="/dong-san-pham/add" method="post" class="needs-validation" novalidate="">
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="mb-3 row">
                                                <label class="col-lg-4 col-form-label" for="validationCustom02">Tên dòng
                                                    sản
                                                    phẩm
                                                ...
                                                <div class="col-lg-6">
                                                    <input name="ten" type="text" class="form-control"
                                                           ...
                                                           placeholder="Nhập tên dòng.." required="">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="mb-3 row">
                                                <div class="col-lg-8 ms-auto">
                                                    <button type="submit" class="btn btn-primary">Thêm dòng sản phẩm
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">DANH SÁCH DÒNG SẢN PHẨM</h4>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-responsive-md">
                                    ...
                                    <tr>
                                        ...
                                        <th><strong>MÃ DÒNG SẢN PHẨM</strong></th>
                                        <th><strong>TÊN DÒNG SẢN PHẨM</strong></th>
                                        <th></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <c:forEach var="i" items="${listDongSanPham}" varStatus="status">
                                        <tr>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a class="dropdown-item"
                                                           href="/dong-san-pham/delete?idDongSp=${i.id}">Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                    ...
                    <div class="modal-body">
                        <form id="formUpdate" action="#" method="post"
                            ...
                            <div class="row">
                                <div class="col-xl">
                                    <div class="mb-3 row">
                                        <label class="col-lg-4 col-form-label" for="productMa">Mã dòng
                                            <span class="text-danger">*</span>
                                        </label>
                                        <div class="col-lg-6">
                                            <input disabled value="{{object.ma}}" type="text" name="maUpdate"
                                                   class="form-control"
                                                   id="productMa"
                                                   placeholder="Nhập mã.." required>
                                            <div class="invalid-feedback">
                                                Vui lòng nhập mã dòng
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label class="col-lg-4 col-form-label" for="productTen">Tên dòng
                                            <span class="text-danger">*</span>
                                        </label>
                                        <div class="col-lg-6">
                                            <input value="{{object.ten}}" ng-model="object.ten" type="text"
                                                   name="tenUpdate"
                                                   class="form-control"
                                                   id="productTen"
                                                   placeholder="Nhập tên.." required>
                                            <div class="invalid-feedback">
                                                Vui lòng nhập tên dòng
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
...
<script>
    ...
    myApp.controller('myCtrl', function ($scope) {
        ...
        $scope.getDataToModal = function (event) {
            ...
            document.getElementById("formUpdate").action = "/dong-san-pham/update?idDongSp=" + $scope.object.id
        }
    })
</script>
</body>
