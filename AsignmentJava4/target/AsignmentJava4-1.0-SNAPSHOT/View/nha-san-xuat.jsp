                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-validation">
                                <form action="/nha-san-xuat/add" method="post" class="needs-validation" novalidate="">
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="mb-3 row">
                                                <label class="col-lg-4 col-form-label" for="validationCustom02">Tên nhà
                                                    sản xuất
                                        ...
                                        <div class="col-xl-6">
                                            <div class="mb-3 row">
                                                <div class="col-lg-8 ms-auto">
                                                    <button type="submit" class="btn btn-primary">Thêm nhà sản xuất
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-responsive-md">
                                    ...
                                    <tbody>
                                    <c:forEach var="i" items="${listNhaSanXuat}" varStatus="status">
                                        <tr>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a class="dropdown-item"
                                                           href="/nha-san-xuat/delete?idNsx=${i.id}">Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                    ...
                    <div class="modal-body">
                        <form id="formUpdate" action="#" method="post"
                            ...
                            <div class="row">
                                <div class="col-xl">
                                    <div class="mb-3 row">
                                        <label class="col-lg-4 col-form-label" for="productMa">Mã nhà sản xuất
                                            <span class="text-danger">*</span>
                                        </label>
                                        <div class="col-lg-6">
                                            ...
                                            <div class="invalid-feedback">
                                                Vui lòng nhập mã nhà sản xuất
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label class="col-lg-4 col-form-label" for="productTen">Tên nhà sản xuất
                                            <span class="text-danger">*</span>
                                        </label>
                                        <div class="col-lg-6">
...
<script>
    ...
    myApp.controller('myCtrl', function ($scope) {
        ...
        $scope.getDataToModal = function (event) {
            ...
            document.getElementById("formUpdate").action = "/nha-san-xuat/update?idNsx=" + $scope.object.id
        }
    })
</script>
</body>
