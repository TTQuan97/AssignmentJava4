                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-validation">
                                <form action="/mau-sac/add" method="post" class="needs-validation" novalidate="">
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="mb-3 row">
                                                <label class="col-lg-4 col-form-label" for="validationCustom02">Tên màu
                            ...
                            <div class="table-responsive">
                                <table class="table table-responsive-md">
                                    ...
                                    <tr>
                                        ...
                                        <th><strong>MÃ MÀU</strong></th>
                                        <th><strong>TÊN MÀU</strong></th>
                                        <th></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <c:forEach var="i" items="${listMauSac}" varStatus="status">
                                        <tr>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a class="dropdown-item"
                                                           href="/mau-sac/delete?idMauSac=${i.id}">Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                    ...
                    <div class="modal-body">
                        <form id="formUpdate" action="#" method="post"
                            ...
                            <div class="row">
                                <div class="col-xl">
                                    <div class="mb-3 row">
                                        <label class="col-lg-4 col-form-label" for="productMa">Mã màu
                                            <span class="text-danger">*</span>
                                        </label>
                                        <div class="col-lg-6">
                                    ...
                                    <div class="mb-3 row">
                                        <label class="col-lg-4 col-form-label" for="productTen">Tên màu sắc
                                            <span class="text-danger">*</span>
                                        </label>
                                        <div class="col-lg-6">
...
<script>
    ...
    myApp.controller('myCtrl', function ($scope) {
        ...
        $scope.getDataToModal = function (event) {
            ...
            document.getElementById("formUpdate").action = "/mau-sac/update?idMauSac=" + $scope.object.id
        }
    })
</script>
</body>
