                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Thêm Mới Cửa Hàng</h4>
                        </div>
                        <div class="card-body">
                            <div class="form-validation">
                                <form action="/cua-hang/add" method="post" class="needs-validation" novalidate="">
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="mb-3 row">
                                                <label class="col-lg-4 col-form-label" for="validationCustom02">Tên cửa
                                                    hàng
                                            ...
                                            <div class="mb-3 row">
                                                <label class="col-lg-4 col-form-label" for="validationCustom022">Địa chỉ
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                            ...
                            <div class="table-responsive">
                                <table class="table table-responsive-md">
                                    ...
                                    <tr>
                                        ...
                                        <th><strong>MÃ CỬA HÀNG</strong></th>
                                        <th><strong>TÊN CỬA HÀNG</strong></th>
                                    ...
                                    <tbody>
                                    <c:forEach var="i" items="${listCuaHang}" varStatus="status">
                                        <tr>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a ng-click="getDataToModal($event)" href="#"
                                                           ...
                                                           data-diachi="${i.diaChi}" data-thanhpho="${i.thanhPho}"
                                                           data-quocgia="${i.quocGia}">
                                                            Edit
                                                        </a>
                                                        <!-- Button trigger modal end -->
                                                        <a class="dropdown-item"
                                                           href="/cua-hang/delete?idCuaHang=${i.id}">Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                    ...
                    <div class="modal-body">
                        <form id="formUpdate" action="#" method="post"
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="mb-3 row">
                                        <label class="col-lg-4 col-form-label" for="111">Mã cửa hàng
                                            <span class="text-danger">*</span>
                                        </label>
                                        <div class="col-lg-6">
                                    ...
                                    <div class="mb-3 row">
                                        <label class="col-lg-4 col-form-label" for="222">Tên cửa hàng
                                            <span class="text-danger">*</span>
                                        </label>
                                        <div class="col-lg-6">
                                    ...
                                    <div class="mb-3 row">
                                        <label class="col-lg-4 col-form-label" for="validationCustom0226">Địa chỉ
                                            <span class="text-danger">*</span>
                                        </label>
                                        <div class="col-lg-6">
                                ...
                                <div class="col-xl-6">
                                    <div class="mb-3 row">
                                        <label class="col-lg-4 col-form-label" for="validationCustom0625">Thành
                                            phố
                                            <span class="text-danger">*</span>
                                        </label>
                                        <div class="col-lg-6">
                                            <input name="thanhphoUpdate" ng-model="object.thanhPho"
                                                   ng-value="object.thanhPho" type="text"
                                                   class="form-control"
                                                   id="validationCustom0625"
                                                   placeholder="Nhập thành phố.." required="">
                                            <div class="invalid-feedback">
                                                Vui lòng nhập thành phố
                                            </div>
                                    ...
                                    <div class="mb-3 row">
                                        <label class="col-lg-4 col-form-label" for="validationCustom0925">Quốc
                                            gia
                                            <span class="text-danger">*</span>
                                        </label>
                                        <div class="col-lg-6">
...
<script>
    ...
    myApp.controller('myCtrl', function ($scope) {
        ...
        $scope.getDataToModal = function (event) {
            ...
            document.getElementById("formUpdate").action = "/cua-hang/update?idCuaHang=" + $scope.object.id
        }
    })
</script>
</body>
