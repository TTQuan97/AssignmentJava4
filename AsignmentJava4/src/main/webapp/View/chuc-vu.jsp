        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Chức vụ</a></li>
                </ol>
            </div>
            <!-- row -->
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-validation">
                                <form action="/chuc-vu/add" method="post" class="needs-validation" novalidate="">
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="mb-3 row">
                                                <label class="col-lg-4 col-form-label" for="validationCustom02">Tên chức
                                                    vụ
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-responsive-md">
                                    ...
                                    <tbody>
                                    <c:forEach var="i" items="${listChucVu}" varStatus="status">
                                        <tr>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a class="dropdown-item"
                                                           href="/chuc-vu/delete?idChucVu=${i.id}">Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                    ...
                    <div class="modal-body">
                        <form id="formUpdate" action="#" method="post"
                            ...
                            <div class="row">
                                <div class="col-xl">
                                    <div class="mb-3 row">
                                        <label class="col-lg-4 col-form-label" for="productMa">Mã chức vụ
                                            <span class="text-danger">*</span>
                                        </label>
                                        <div class="col-lg-6">
                                    ...
                                    <div class="mb-3 row">
                                        <label class="col-lg-4 col-form-label" for="productTen">Tên chức vụ
                                            <span class="text-danger">*</span>
                                        </label>
                                        <div class="col-lg-6">
...
<script>
    ...
    myApp.controller('myCtrl', function ($scope) {
        ...
        $scope.getDataToModal = function (event) {
            ...
            document.getElementById("formUpdate").action = "/chuc-vu/update?idChucVu=" + $scope.object.id
        }
    })
</script>
</body>
